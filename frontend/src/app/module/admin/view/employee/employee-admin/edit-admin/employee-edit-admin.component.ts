...
export class EmployeeEditAdminComponent extends AbstractEditController<EmployeeDto, EmployeeCriteria, EmployeeService>   implements OnInit {
    ...
    constructor( private employeeService: EmployeeService , private categorieEmployeeService: CategorieEmployeeService, private typeCongeService: TypeCongeService, private absenceService: AbsenceService, private uniteAdministrativeService: UniteAdministrativeService, private congeService: CongeService, private contratService: ContratService, private typeAbsenceService: TypeAbsenceService) {
